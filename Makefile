...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/09/24 18:40:34 by kvandenb          #+#    #+#              #
#    Updated: 2017/10/05 19:53:04 by kvandenb         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
ft_toupper.c ft_tolower.c ft_atoi.c ft_strdup.c ft_strlen.c ft_strcpy.c \
ft_strncpy.c ft_strcat.c ft_strncat.c ft_strlcat.c ft_strchr.c ft_strrchr.c \
ft_strstr.c ft_strnstr.c ft_strcmp.c ft_strncmp.c ft_memset.c ft_bzero.c \
...
ft_putnbr.c ft_putchar_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_putstr_fd.c \
ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c \
ft_putarray.c ft_putarray_fd.c ft_counthidden.c ft_countwords.c ft_iseven.c
...
ft_putendl_fd.o ft_putnbr_fd.o ft_strnew.o ft_strdel.o ft_lstnew.o ft_lstdelone.o \
ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_putarray.o ft_putarray_fd.o \
ft_counthidden.o ft_countwords.o ft_iseven.o
